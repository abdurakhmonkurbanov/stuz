...
<div class="main-container">
    ...
    <div class="sptb section bg-white" id="Features">
        <div class="container">
            <div class="row">
                <h2 class="text-center fw-semibold">Kompyuter savodxonligi kursi</h2>
                <span class="landing-title"></span>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-1 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                <a href="#"> <h4 class="fw-bold">Quality &amp; Clean Code</h4></a>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card  features main-features main-features-6 wow fadeInUp reveal revealleft"
                            data-wow-delay="0.1s">
                            <div class="bg-img mb-2 text-left">
    ...
    <!-- ROW-4 OPEN Features Used in Sash Admin Template-->
    <div class="section testimonial-owl-landing">
        <div class="container">
            <div class="row">
                <div class="card bg-transparent mb-0">
                    <h2 class="text-center fw-semibold text-white">Fanlar</h2>
                    <span class="landing-title"></span>
                ...
                <section class="sptb demo-screen-demo" id="faqs">
                    <div class="container">
                        <div class="row align-items-center">
                            <h4 class="text-center fw-semibold">Xizmatlar</h4>
                            <span class="landing-title"></span>
                                                ...
                                                <div class="card-header grid-link"
                                                    ...
                                                    <a href="#"
                                                        class="card-options-collapse h5 fw-bold card-title mb-0 text-primary"><span
                                                            class="badge"><i
                                                                class="fe fe-chevron-up fs-15 me-3"></i></span>Liderlar maktab</a>
                                                </div>
                                                ...
                                                <div class="card-header grid-link"
                                                    ...
                                                    <a href="#"
                                                        class="card-options-collapse  h5 fw-bold card-title mb-0 text-success"><span
                                                            class="badge"><i
                                                                class="fe fe-chevron-up fs-15 me-3"></i></span>OTM ga tayyorlanish</a>
                                                </div>
                                                <div class="card-body pt-0">
                                                    <p class="mb-3">
                                                        The Sash – Bootstrap 5 Admin & Dashboard
                                                ...
                                                <div class="card-header grid-link"
                                                    ...
                                                    <a href="#"
                                                        class="card-options-collapse  h5 fw-bold card-title mb-0 text-info"><span
                                                            class="badge"><i
                                                                class="fe fe-chevron-up fs-15 me-3"></i></span>PIIMA savollari</a>
                                                </div>
                                                <div class="card-body pt-0">
                                                    <p class="mb-3">
                                                        The Sash – Bootstrap 5 Admin & Dashboard
                                                ...
                                                <div class="card-header grid-link"
                                                    ...
                                                    <a href="#"
                                                        class="card-options-collapse  h5 fw-bold card-title mb-0 text-secondary"><span
                                                            class="badge"><i
                                                                class="fe fe-chevron-up fs-15 me-3"></i></span>Pedagoglar maktab</a>
                                                </div>
                                                <div class="card-body pt-0">
                                                    <p>
                                                        The Sash – Bootstrap 5 Admin & Dashboard
                                                ...
                                                <div class="card-header grid-link"
                                                    ...
                                                    <a href="#"
                                                        class="card-options-collapse  h5 fw-bold card-title mb-0 text-warning"><span
                                                            class="badge"><i
                                                                class="fe fe-chevron-up fs-15 me-3"></i></span>Atestatsiya savollari</a>
                                                </div>
                                                <div class="card-body pt-0">
                                                    <p>
                                                        The Sash – Bootstrap 5 Admin & Dashboard
    ...
    <!-- ROW-8 OPEN Nazorat savollari-->
    <div class="section bg-landing" id="Blog">
        <div class="container">
            <div class="row">

                <span class="landing-title"></span>
                <h2 class="text-center fw-semibold mb-7">Nazorat savollari</h2>
                <div class="col-lg-6">
                        ...
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html"
                                    ...
                                    style="background: url(&quot;/assets/images/pngs/leader.png&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                                    <span
                                        class="badge bg-primary me-1 mb-1 mt-1">Leaders</span>
                                    <h3><a href="blog-details.html">Rahbarlar uchun</a></h3>
                        ...
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html"
                                    ...
                                    style="background: url(&quot;/assets/images/pngs/teacher.png&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                                    <span
                                        class="badge bg-danger me-1 mb-1 mt-1">Teachers</span>
                                    <h3><a href="blog-details.html">O'qituvchilar uchun</a></h3>
                                    <div class="">Excepteur sint occaecat cupidatat non
                                        proident, accusantium sunt in culpa qui officia deserunt
                                        mollit anim id est laborum....</div>
                                </div>
                        ...
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html"
                                    ...
                                    style="background: url(&quot;/assets/images/pngs/students.png&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                                    <span
                                        class="badge bg-secondary me-1 mb-1 mt-1">Pupils</span>
                                    <h3><a href="blog-details.html">O'quvchilar uchun</a></h3>
                                    <div class="">Excepteur sint occaecat cupidatat non
                                        proident, accusantium sunt in culpa qui officia deserunt
                                        mollit anim id est laborum....</div>
                                </div>
                        ...
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html"
                                    ...
                                    style="background: url(&quot;/assets/images/pngs/parents.png&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                                    <span class="badge bg-success me-1 mb-1 mt-1">parents</span>
                                    <h3><a href="blog-details.html">Ota-onalar uchun</a></h3>
                                    <div class="">Excepteur sint occaecat cupidatat non
                                        proident, accusantium sunt in culpa qui officia deserunt
                                        mollit anim id est laborum....</div>
                                </div>
        ...
        <div class="container">
            <div class="">
                <div class="card card-shadow reveal">
                    <h4 class="text-center fw-semibold mt-7">Biz bilan bog'laning</h4>
                    <span class="landing-title"></span>
